        ...
        <div className="mt-5 grid gap-5 xl:grid-cols-[280px_minmax(0,1fr)]">
          ...
          <main className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="divide-y divide-slate-100 px-5">
              ...
              {notification.isNew && 
              <span className="rounded-md bg-emerald-50 px-2 py-0.5 text-[10px] font-semibold text-emerald-700">New</span>}
              </div>
              ...
              {!visibleNotifications.length && <div className="py-16 text-center">
                ...
                <p className="mt-1 text-sm text-slate-500">There are no notifications in this category.</p>
                </div>}
            </div>
